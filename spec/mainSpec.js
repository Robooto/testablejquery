...
describe('stockRetriever', function () {
    ...
    describe('app', function () {
        ...
        describe('init', function () {
            ...
            it('should create keydown handler on select button selector', function() {
                var selectors = app.configuration.selectors;
                spyOn(selectors.symbol, 'on');
                
                app.init();
                expect(selectors.symbol.on).toHaveBeenCalledWith('keydown', app.test);
            });
